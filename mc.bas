...
700 rem if  b>127 and  b<204 and  q=0 then  poke  782,255: poke  768,185: poke  783,128: sys  42775
710 if  q then  650
...
1830 rem input  "{control-q}name des quelltextes";s$
