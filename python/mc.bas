...
12 print "by Vic Cortes, published in RUN 07/86"
13 print "compiled to Python using MOSpeed by EgonOlsen71"
14 print "visit https://www.jpct.de/mc/ for details":print
...
1830 input  "{control-q}source name";s$
1840 restore  : if  s$="*" or s$="" then  end 
1850 input  "start address";s: print  :a=s+6
...
2050 print  "address range:";s;"{left}";e*-1
2060 print  s$;" compiled, time:";ti$
2070 print  "{control-q}1=save 2=comp 3=quit": poke  198,0
2080 get  x$: if  x$="1" then  2170
2100 if  x$="2" then  gosub  1820: goto  590
2110 if  x$="3" then  end 
2130 goto  2080
...
2230 poke  781,e-peek(782)*256: sys  65496:print"saved ";n$
